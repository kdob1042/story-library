...
import { joinWorkPath, manifestEntryPath, safeWorkRelativePath } from '../contracts/library/paths.mjs';
...
test('manuscript paths resolve from the work root, not source/', () => {
  ...
  assert.equal(manifestEntryPath('works/kamiya-kawai'), 'works/kamiya-kawai/source/manifest.json');
  assert.equal(safeWorkRelativePath('source/manifest.json'), 'source/manifest.json');
});
